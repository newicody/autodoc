# 0086-r2-part12_25_scheduler_route_adapter

Remplace l'ancien `0086-part12_25_scheduler_route_adapter`, non validé à cause d'une phrase exacte de rule test.

## Phase 0086

Adapter minimal du Scheduler existant vers `prepare_route_for_scheduler()`.
...
PATCH_ID=0086-r2-part12_25_scheduler_route_adapter
