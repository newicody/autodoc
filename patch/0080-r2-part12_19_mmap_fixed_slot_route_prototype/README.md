# 0080-r2-part12_19_mmap_fixed_slot_route_prototype

Remplace l'ancien `0080-part12_19_mmap_fixed_slot_route_prototype`, qui avait une phrase de doc incompatible avec une rule test.

## Scope

Prototype `mmap fixed-slot` qui consomme une decision ControlProxy `ready` issue de `0079-r2/r3` et materialise :
...
PATCH_ID=0080-r2-part12_19_mmap_fixed_slot_route_prototype
