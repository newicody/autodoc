# 0085-r2-part12_24_scheduler_route_handshake

Remplace l'ancien `0085-part12_24_scheduler_route_handshake`, non validé à cause d'une phrase exacte de rule test.

## Phase 0085

Handshake côté Scheduler, sans service/daemon/CLI.
...
PATCH_ID=0085-r2-part12_24_scheduler_route_handshake
