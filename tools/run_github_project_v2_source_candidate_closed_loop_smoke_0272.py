#!/usr/bin/env python3
"""Run the r7 -> SQL -> E5/Qdrant -> SQL ProjectV2 closed-loop smoke."""
...
from context.github_project_v2_source_candidate_closed_loop_smoke_0272 import (  # noqa: E402
...
_DEFAULT_OUTPUT = Path(
    ".var/reports/github_project_v2_source_candidate_closed_loop_smoke_0272.json"
)
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    gate_record = _read_json(_repo_path(args.gate_record))
