...
Si une phase introduit une nouvelle technique de programmation, une nouvelle frontière d'IO, une nouvelle politique, un nouveau backend, une nouvelle forme d'adaptateur ou une nouvelle exception apparente, elle doit proposer un ajout minimal à `code_rule.md`.
...
```text
doc/manifests/MANIFEST_CHANGED_FILES.md
doc/CHANGELOG_*.md
