...
La première proposition 4.12 réécrivait trop largement `doc/code-rules/code_rule.md`.
La version r2 conserve l'ancien fichier comme base et ajoute seulement un addendum court d'application aux phases E5.

## Ajout principal

- `doc/code-rules/code_rule.md` conserve la philosophie micro-kernel initiale.
